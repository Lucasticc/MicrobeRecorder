...
public final class ItemPhotoBinding implements ViewBinding {
  ...
  private ItemPhotoBinding(@NonNull FrameLayout rootView, @NonNull TextView ivDelete,
  ...
  public static ItemPhotoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.ivDelete;
      TextView ivDelete = ViewBindings.findChildViewById(rootView, id);
      if (ivDelete == null) {
        break missingId;
      }
      ...
      return new ItemPhotoBinding((FrameLayout) rootView, ivDelete, ivPhoto);
    }
